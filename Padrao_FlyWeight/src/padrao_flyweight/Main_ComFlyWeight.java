 ...
 * @author 20161bsi0403
 */
public class Main_ComFlyWeight {
    public static void main(String[] args) {            
        ArrayList<Pedido> listaPedidos = new ArrayList();  
        FlyweightStatusItem fly = new FlyweightStatusItem();
        Browser brow = new Browser();
        brow.putAllStatus(fly);
        ...
        for(int i=0; i< 200000; i++){             
            ...
            item1.setNome("lapis");                        
            item1.setStatus(fly.getStatusItem(Estado.CARRINHO));
            Item item2 = new Item();
            item2.setDescricao("caneta cor azul");
            item2.setNome("caneta");                                    
            item2.setStatus(fly.getStatusItem(Estado.CARRINHO));
            Item item3 = new Item();
            item3.setDescricao("caneta cor vermelha");
            item3.setNome("caneta");                        
            item3.setStatus(fly.getStatusItem(Estado.CARRINHO));                       
