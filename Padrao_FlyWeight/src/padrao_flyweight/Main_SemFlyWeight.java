 ...
 * @author Salzman
 */
public class Main_SemFlyWeight {
    /**
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i< 200000; i++){             
            ...
            item1.setNome("lapis");                        
            item1.setStatus(new StatusItem(Estado.CARRINHO , true, false));
            Item item2 = new Item();
            item2.setDescricao("caneta cor azul");
            item2.setNome("caneta");                                    
            item2.setStatus(new StatusItem(Estado.CARRINHO , true, false));
            Item item3 = new Item();
            item3.setDescricao("caneta cor vermelha");
            item3.setNome("caneta");                        
            item3.setStatus(new StatusItem(Estado.CARRINHO , true, false));                       
